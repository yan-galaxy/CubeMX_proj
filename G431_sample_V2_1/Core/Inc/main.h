...
extern Word_union test_data[1004];
extern Word_union res_data_1[1004];
extern Word_union res_data_2[1004];
extern Word_union* res_send_p;
extern Word_union* res_store_p;
/* USER CODE END EC */
