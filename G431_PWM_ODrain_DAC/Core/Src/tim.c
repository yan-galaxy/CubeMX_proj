...
/*
主频170MHz Period为1即相当于二分频  
所以85Mhz/Prescaler的结果就是最后输出PWM的频率，调整Prescaler即可调整频率
滤波器截止频率是PWM的1/100
...
41-20kHz  84-10kHz  849-1kHz  1132-750Hz  1699-500Hz  3199-250Hz   

*/
  /* USER CODE END TIM2_Init 1 */
  htim2.Instance = TIM2;
  htim2.Init.Prescaler = 1065;
